...
class MyTestCase(unittest.TestCase):
    def test_primitive_types_serialization(self):
        expected = primitive
        actual = json_serializer.loads(json_serializer.dumps(primitive))
        self.assertEqual(expected, actual)

    def test_simple_function_serialization(self):
        expected = simple_function(10)
        actual = json_serializer.loads(json_serializer.dumps(simple_function))(10)
        self.assertEqual(expected, actual)

    def test_recursive_function_serialization(self):
        expected = recursive_function(10)
        actual = json_serializer.loads(json_serializer.dumps(recursive_function))(10)
        self.assertEqual(expected, actual)

    def test_lambda_expression_serialization(self):
        expected = lambda_expression(10)
        actual = json_serializer.loads(json_serializer.dumps(lambda_expression))(10)
        self.assertEqual(expected, actual)

    def test_closure_function_serialization(self):
        expected = closure_function(5)(6)

        actual = json_serializer.loads(json_serializer.dumps(closure_function))(5)(6)
        self.assertEqual(expected, actual)
    ...
    def test_generator_serialization(self):
        ...
        actual = ''
        for i in json_serializer.loads(json_serializer.dumps(generator))(6):
            actual += i
    ...
    def test_decorator_serialization(self):
        ...
        actual = json_serializer.loads(json_serializer.dumps(my_func))(6)
        self.assertEqual(expected, actual)

        new = json_serializer.loads(json_serializer.dumps(simple_decorator))
    ...
    def test_class_methods_serialization(self):
        new = json_serializer.loads(json_serializer.dumps(person))
        New = json_serializer.loads(json_serializer.dumps(Person))
    ...
    def test_class_serialization(self):
        expected = A.x
        actual = json_serializer.loads(json_serializer.dumps(A)).x
        self.assertEqual(expected, actual)

        expected = B.x
        actual = json_serializer.loads(json_serializer.dumps(B)).x
        self.assertEqual(expected, actual)

    def test_object_serialization(self):
        expected = vars(person)
        actual = vars(json_serializer.loads(json_serializer.dumps(person)))
        self.assertEqual(expected, actual)
